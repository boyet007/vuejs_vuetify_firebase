<template>
    <v-dialog persistent="" v-model="registerDialog">
        ...
        <v-card>
                <v-layout row wrap>
                    <v-flex xs12>
                        <v-card-title primary-title v-if="userIsRegistered"><h2>Unregister from Meetup?</h2></v-card-title>
                        <v-card-title primary-title v-else><h2>Registerer for Meetup?</h2></v-card-title>
                    </v-flex>
                </v-layout>
                <v-divider></v-divider>
                <v-layout row wrap>
